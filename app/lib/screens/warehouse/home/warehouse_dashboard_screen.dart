            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: StatCard(
                        title: 'Pending GRNs',
                        value: kpiText(stats, 'pendingGRNs'),
                    ...
                    Expanded(
                      child: StatCard(
                        title: 'Put-aways',
                        value: kpiText(stats, 'pendingPutAways'),
                        icon: Icons.shelves,
                        color: AppTheme.primary,
                      ),
                    ),
                  ...
                  children: [
                    Expanded(
                      child: StatCard(
                        ...
                        value: kpiText(stats, 'issueRequests'),
                ...
                _WorklistCard(
                  ...
                  title: 'GRNs Pending',
                  count: kpiInt(stats, 'pendingGRNs'),
                  subtitle: '1 overdue',
                ...
                _WorklistCard(
                  ...
                  title: 'Put-aways',
                  count: kpiInt(stats, 'pendingPutAways'),
                  subtitle: '4 items ready',
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const PutAwayListScreen(),
                    ),
                  ),
                ),
                const SizedBox(height: 10),
                _WorklistCard(
                  ...
                  title: 'Issue Requests',
                  count: kpiInt(stats, 'issueRequests'),
                  subtitle: '1 overdue',
                  subtitleColor: AppTheme.danger,
                  onTap: () => Navigator.push(
                    context,
                ...
                _WorklistCard(
                  ...
                  title: 'Counts Due',
                  count: kpiInt(stats, 'countsDue'),
                  subtitle: '1 overdue',
                  subtitleColor: AppTheme.danger,
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const CycleCountListScreen(),
                    ),
                  ),
                ),
